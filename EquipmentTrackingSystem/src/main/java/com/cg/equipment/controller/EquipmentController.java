...
public class EquipmentController {
	...
	@RequestMapping(method=RequestMethod.GET,value= {"/recordsbyLocation/{equipmentType}"})
	public ResponseEntity<EquipmentRecord> viewByEquipmentType(@PathVariable(value="equipmentType") String equipmentType) throws TrackingException{
		return new ResponseEntity<EquipmentRecord>(service.findByEquipmentType(equipmentType),HttpStatus.OK);
	}
	
	@RequestMapping(method=RequestMethod.GET,value= {"/recordsbyLocation/{seqNo}"})
	public ResponseEntity<EquipmentRecord> viewBySeqNo(@PathVariable(value="seqNo") String seqNo) throws TrackingException{
